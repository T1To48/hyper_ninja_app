...
import { IUserRegisterReq, useRegisterMutation } from "../../features/api.userEndpoints";
      ...
      <div className="register-component flex">
        <header>
          ...
          <form onSubmit={(e)=>void newUser(e)}>
           ...
           <div className="register-btn-container"> <button type="submit"> Register</button></div>
          </form>
          <div>
            <br />
            <p>
              Already Have An Account? <span onClick={()=>dispatch(openLoginModal())}> Login</span>
            </p>
          </div>
        </header>
        <footer>
